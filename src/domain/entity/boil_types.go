...
func AllTransferstatus() []Transferstatus {
...
func (e Transferstatus) IsValid() error {
	switch e {
	case TransferstatusFailed, TransferstatusPending, TransferstatusSuccess:
		return nil
	default:
...
func (e Transferstatus) Ordinal() int {
	switch e {
